      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            >
              <div className="text-2xl font-bold">
                {/* add logo */}
                <span className="pr-2">
                  <img src="/logo.jpg" alt="Logo" className="h-10 inline" />
                </span>
          ...
          <div className="md:pl-14">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-marketing-400 hover:text-white transition-colors"
                >
                  Event Organization
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  href="tel:+917777048666"
                  className="flex items-center text-marketing-400 hover:text-white transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
        ...
        <div className="border-t border-marketing-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="#"
              className="text-marketing-400 hover:text-white text-sm transition-colors"
            >
              Privacy Policy
            </a>
            <a
