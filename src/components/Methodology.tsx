  ...
  const steps = [
    {
      ...
      title: "Discovery",
      description:
        "We begin with a deep dive into your brand, audience, and goals to understand the unique challenges and opportunities.",
      details: [
        "Business audit",
        "Process mapping",
    ...
    },
    {
      ...
      title: "Strategy",
      description:
        "Our team crafts a comprehensive marketing strategy tailored to your specific needs and market positioning.",
      details: [
        "Market research",
    ...
    },
    {
      ...
      title: "Creation",
      description:
        "We develop creative assets and campaigns that align with your brand identity and resonate with your target audience.",
      details: [
        "Content creation",
    ...
    },
    {
      ...
      title: "Execution",
      description:
        "Our experts deploy campaigns across relevant channels, managing every detail to ensure flawless implementation.",
      details: [
        "Campaign launch",
    ...
    },
    {
      ...
      title: "Analysis",
      description:
        "We continuously monitor performance, providing detailed analytics and optimizing for maximum impact.",
      details: [
        "Data analysis",
        "Reporting",
      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16 reveal-on-scroll">
          ...
          <p className="text-white/80 text-lg">
            Our systematic approach ensures consistent results and measurable
            impact for all your marketing initiatives.
          </p>
        </div>
